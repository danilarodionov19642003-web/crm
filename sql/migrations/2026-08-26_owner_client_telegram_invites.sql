-- Let the CRM owner create a one-time Telegram linking URL for a client who
-- does not sign in to the web cabinet. The existing bot consumes the same
-- invite table and remains the only service allowed to bind Telegram IDs.
