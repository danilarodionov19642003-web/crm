...
(function () {
  ...
  const NAV = [
    ...
    { id: 'projects',      label: 'Проекты',    href: 'projects.html',      icon: icoProjects(), ownerOnly: true },
    ...
    { id: 'client-access', label: 'Кабинеты клиентов', href: 'client-access.html', icon: icoKey(),  ownerOnly: true }
  ];
  ...
  function icoProjects() {
    return `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7h6l2 2h10v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z"/><path d="M3 7V5a2 2 0 0 1 2-2h4l2 2h6a2 2 0 0 1 2 2v2"/></svg>`;
  }
  function icoPhones() {
  ...
  function icoKey() {
    return `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="7.5" cy="15.5" r="4.5"/><path d="M10.5 12.5 21 2"/><path d="M16 7l3 3"/><path d="M19 4l3 3"/></svg>`;
  }
