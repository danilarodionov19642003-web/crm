...
assert.ok(result.phoneExpense, 'замена на другой номер должна создать новый расход');
assert.equal(Store.state.expenses.length, 2);
assert.equal(Store.state.expenses[1].id, 'phone-cost-89992223344');
